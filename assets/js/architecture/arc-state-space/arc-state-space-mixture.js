...
var url = '../warehouse/architecture/arc-state-space-mixture/live/menu/menu.json';
...
function generateChart(fileNameKey){
    ...
    $.getJSON('../warehouse/architecture/arc-state-space-mixture/live/points/predictions/' + fileNameKey + '.json', function (source)  {
